            ...
            <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item">
                        <img className="d-block w-100" src="https://s3-us-west-2.amazonaws.com/media.forumbee.com/i/96611901-29ba-444a-b140-d9f1f31c9d0e/h/547.png" alt="First slide" />
                    ...
                    <div className="carousel-item  active">
                        <img className="d-block w-100" src="https://s3-us-west-2.amazonaws.com/media.forumbee.com/i/0451ed98-b52f-4b21-a56b-e46c73f660fd/h/547.png" alt="Second slide" />
                        <div className="carousel-caption d-none d-md-block">
                            <h5>Build Your Knowledge</h5>
                            <p>Learn & Grow</p>
                        </div>
                    ...
                    <div className="carousel-item">
                        <img className="d-block w-100" src="https://s3-us-west-2.amazonaws.com/media.forumbee.com/i/2e9088c3-2f5d-4e79-9675-87ce87878e06/h/547.png" alt="Third slide" />
                        <div className="carousel-caption d-none d-md-block">
                            <h5>Build Your Knowledge</h5>
                            <p>Learn & Grow</p>
                        </div>
                    ...
                    <div className="carousel-item">
                        <img className="d-block w-100" src="https://s3-us-west-2.amazonaws.com/media.forumbee.com/i/5edd90c6-ef62-4b19-bc37-fa30afd9df09/h/547.png" alt="Third slide" />
                        <div className="carousel-caption d-none d-md-block">
                            <h5>Build Your Knowledge</h5>
                            <p>Learn & Grow</p>
                        </div>
                ...
                <div className="home-about">
                    <div className="row">
                        <div className="col-md-6 layout_padding_2">
                            <div className="full">
                                <div className="heading_main_text_align_left">
